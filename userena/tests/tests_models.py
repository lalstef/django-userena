...
class UserenaSignupModelTests(TestCase):
    ...
    def test_plain_email(self):
        ...
        new_user = UserenaSignup.objects.create_user(**self.user_info)
        self.failUnlessEqual(len(mail.outbox), 1)
        self.assertEqual(six.text_type(mail.outbox[0].message()).find("multipart/alternative"),-1)
    ...
    def test_html_email(self):
        ...
        userena_settings.USERENA_HTML_EMAIL = False
        self.failUnlessEqual(len(mail.outbox), 1)
        self.assertTrue(six.text_type(mail.outbox[0].message()).find("multipart/alternative")>-1)
        self.assertTrue(six.text_type(mail.outbox[0].message()).find("text/plain")>-1)
        self.assertTrue(six.text_type(mail.outbox[0].message()).find("text/html")>-1)
        self.assertTrue(six.text_type(mail.outbox[0].message()).find("<html>")>-1)
        self.assertTrue(six.text_type(mail.outbox[0].message()).find("<p>Thank you for signing up")>-1)
